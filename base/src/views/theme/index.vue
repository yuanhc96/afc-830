<!-- <template>
  <div class="app-container">
    ...
    <div class="block">
      ...
      <el-button type="primary"> Upload <i class="el-icon-upload el-icon-right" /> </el-button>
    </div>

    <div class="block">
      <el-tag v-for="tag in tags" :key="tag.type" class="tag-item" :type="tag.type"> {{ tag.name }} </el-tag>
    </div>
    ...
    <div class="block"><el-slider v-model="slideValue" /></div>
  </div>
</template>
